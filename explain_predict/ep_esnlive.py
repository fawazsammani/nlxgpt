...
class ExplainPredictDataset(Dataset):
    ...
    def __init__(self, data_path, answer_dic, tokenizer, max_seq_len, gt_test):
        
        self.tokenizer = tokenizer
        self.max_seq_len = max_seq_len     
        self.data = json.load(open(data_path, 'r'))
        self.answer_dic = answer_dic
    ...
    def __getitem__(self, index):
        ...
        answer = torch.LongTensor([self.answer_dic[sample['answer']]])
...
def evaluate(model, inv_answer_dic, loader):
    ...
    for i, (input_ids, attention_masks, answer, qid) in enumerate(loader):
        ...
        for i,pred in enumerate(ind):
            ...
            gt_answer = inv_answer_dic[answer[i].item()]
...
answer_dic = {"contradiction": 0, "neutral": 1, "entailment": 2}
